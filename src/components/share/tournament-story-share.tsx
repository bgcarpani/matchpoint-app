...
import type { TournamentStyle } from '@/lib/og/tournament-story'

/**
 * Flujo de compartir el afiche de difusión del torneo en DOS pasos (espejo de
 * `ChampionStoryShare`):
 ...
 */
const STYLES: { value: TournamentStyle; label: string }[] = [
  { value: 'a', label: 'Afiche' },
  { value: 'b', label: 'Marcador' },
  { value: 'c', label: 'Ficha' },
]

export function TournamentStoryShare({
  storyUrl,
  url,
  text,
}: {
  ...
  const [style, setStyle] = useState<TournamentStyle>('a')
