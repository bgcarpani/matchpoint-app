 ...
 *
 * WhatsApp es click-to-chat (`https://wa.me/?text=…`): abre WhatsApp con el
 * mensaje pre-armado, sin API ni costo.
 *
 * El contrato queda preparado para sumar el botón "Compartir en historia de
 * Instagram" (Slice 4): cuando llegue, recibirá la URL del `/og/story` y usará
 * `navigator.share({ files })` con fallback a descarga.
 */
